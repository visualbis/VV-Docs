...
<<<<<<< HEAD:docs/admin-guide/getting-started/prerequisite/bi-platform-config/looker.md
1. Go to the Embed page in the Admin section of Looker
...
=======
>>>>>>> staging:docs/admin-guide/getting-started/prerequisite/bi-platform-config/looker.mdx
<div class="center">
  <Zoom>
