...
Admins can <Link to={useBaseUrl('docs/admin-guide/agent-manager/agent/agent-management#sync-reports')}>add new Agents</Link> and assign *Agent Name*, *Server URL*, and *Port* number.
