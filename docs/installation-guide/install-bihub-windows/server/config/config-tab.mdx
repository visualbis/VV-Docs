...
:::
  ...
  <div class="center">
    <Zoom>
      <img alt="BI Hub Server Server Configuration" src={useBaseUrl('doc-images/installation-guide/bihub-server-config.png')}/>
    </Zoom>
	<p>BI Hub Server Config tab</p>
  </div>
...
This section establishes a secure connection via SSL between the browser and BI Hub Server.
